        ...
        <div className="container">
          ...
          <div className="row g-3">
            <div className="col-lg-7 col-md-6">
              <div className="row g-3">
                <div className="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                  <Link to="/thailand" className="position-relative d-block overflow-hidden">
                ...
                <div className="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                  <Link to="/malaysia" className="position-relative d-block overflow-hidden">
                ...
                <div className="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                  <Link to="/australia" className="position-relative d-block overflow-hidden">
            ...
            <div className="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" style={{ minHeight: 350 }}>
              <Link to="/indonesia" className="position-relative d-block h-100 overflow-hidden">
                <img
